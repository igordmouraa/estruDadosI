...
export default class LinkedList {
    ...
    remove(pos) {
        ...
        // Armazena o dado removido em um array
    ...
    reverse() {
        ...
        // O antigo head vai virar o novo tail
        this.#tail = this.#head
        ...
        // No final, prev será o novo head
        this.#head = prev
    }
    ...
    removeAll(val) {
        ...
        while (current !== null) {
            ...
            if (current.data === val) {
                ...
                // Só avança previous se NÃO removeu
                previous = current
            }
